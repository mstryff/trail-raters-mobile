...
submitReport = function()
    local requestString = myData.host .. "/report/" .. params.id .. "?trail=" .. inputTrail.text .. "&latitude=" .. inputLatitude.text .. "&longitude=" .. inputLongitude.text .. "&text=" .. inputText.text .. "&rating=" .. inputRating.text
    requestString = string.gsub(requestString, " ", "+")
    network.request(requestString, "PUT", reportSubmitted)
end

reportSubmitted = function(event)
    composer.removeScene( "editreport", false )
